...
public class Parent implements Serializable {
    ...
    private String lastAccessTimeUtc;

    @JsonProperty("LastWriteTime")
    private String lastWriteTime;

    @JsonProperty("LastWriteTimeUtc")
    private String lastWriteTimeUtc;
    ...
    public String getLastAccessTimeUtc() {
        return lastAccessTimeUtc;
    }

    public void setLastAccessTimeUtc(String lastAccessTimeUtc) {
